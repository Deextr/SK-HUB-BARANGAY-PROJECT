...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="bg-white overflow-hidden shadow rounded-lg">
        <div class="px-6 py-5 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Manage your personal information and account security</p>
        </div>
        
        <form method="POST" action="{{ route('resident.settings.update') }}" class="divide-y divide-gray-200" id="settings-form">
            @csrf
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="first_name" id="first_name" 
                                    value="{{ old('first_name', $usersettings->first_name ?? '') }}" 
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="last_name" id="last_name"  
                                    value="{{ old('last_name', $usersettings->last_name ?? '') }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="email" name="email" id="email"  
                                    value="{{ old('email', $usersettings->email ?? '') }}"
